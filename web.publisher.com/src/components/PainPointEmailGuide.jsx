...
export default function PainPointEmailGuide({ subject, body }) {
  ...
  return (
    <div className="rounded-xl border border-indigo-500/20 bg-indigo-500/[0.06] p-3 ring-1 ring-indigo-500/10">
      <p className="text-xs font-semibold text-indigo-200">Pain-first outreach (not a pitch about you)</p>
      ...
      <ul className="mt-2 list-inside list-disc space-y-0.5 text-[11px] text-slate-500">
        ...
        <li>
          ...
          <code className="text-indigo-300/90">{'{option A|option B}'}</code> (paragraphs shuffle too)
        </li>
      </ul>
