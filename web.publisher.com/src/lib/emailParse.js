/** Recipient parsing + merge tags (synced with api emailMerge.js) */
...
export const MERGE_TAG_HELP = [
  { tag: '{{greeting}}', desc: 'Hi Jane or Hi there' },
  { tag: '{{firstName}}', desc: 'First name only' },
  { tag: '{{name}}', desc: 'Full name' },
  { tag: '{{company}}', desc: 'Company name' },
  { tag: '{{niche}}', desc: 'Business niche / industry' },
  { tag: '{{business}}', desc: 'Company or niche' },
  { tag: '{{painOpener}}', desc: 'Auto line about their segment' },
  { tag: '{{companyLabel}}', desc: 'Company or “your company”' },
  { tag: '{{nicheLabel}}', desc: 'Niche or “your industry”' },
]
