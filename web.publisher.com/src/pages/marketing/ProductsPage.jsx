...
const PRODUCTS = [
  ...
  },
  {
    id: 'code-crafters',
    name: 'Code Crafters',
    blurb: '17 tracks · 426 topics & exercises · 120-day MERN roadmap — Shopify, C++, Electron, WordPress, SEO, Prompt Engineering, Python, and more.',
    category: /** @type {ProductCategory} */ ('products'),
    badge: 'Learning',
    image: '/products/code-crafters-dashboard.jpg',
    imageAlt: 'Code Crafters MERN roadmap',
  ...
  },
  {
    ...
    href: 'https://coded-by-aftab.vercel.app/editor?track=javascript',
    cta: 'Open editor',
    featured: true,
  },
  {
    ...
    blurb: 'Track downloads & metadata for your npm packages.',
  ...
  },
  {
    ...
    blurb: 'Soft delete, audit trail, pagination, and optimistic versioning for Mongoose.',
    category: /** @type {ProductCategory} */ ('open-source'),
    badge: 'Open source',
    image: 'https://opengraph.githubassets.com/1/aftab-ahmad-khan-dev/mongoose-advanced-plugin',
    imageAlt: 'Mongoose Advanced Plugin',
    href: 'https://github.com/aftab-ahmad-khan-dev/mongoose-advanced-plugin',
    cta: 'View on GitHub',
    featured: true,
  },
  {
