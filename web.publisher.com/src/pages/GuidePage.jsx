...
import PageShell, { PageScroll, InfoBanner, PageGrid } from '../components/PageShell'
...
const GUIDES = [
  {
    ...
    steps: [
      ...
      'Paste App ID, App Secret, and the Page Token into Integrations → Meta, then Test & save.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Paste Client ID + Secret in Integrations → LinkedIn, then click “Connect with LinkedIn”.',
    ],
  },
  {
    key: 'reddit',
    ...
    steps: [
      ...
      'In Integrations → Reddit, paste them + your subreddit, then click “Connect Reddit”.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Paste the token + Board ID in Integrations → Pinterest, then Test & save.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Paste the token in Integrations → Threads and click Test — it reports your Threads user ID.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Paste Client ID + Secret in Integrations → Gmail, then click “Connect Gmail”.',
    ],
...
function GuideCard({ g }) {
  return (
    <article className="saas-guide-card">
